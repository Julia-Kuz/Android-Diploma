        ...
        val adapter = UserAdapter(object : OnInteractionListenerUser {
            override fun show(user: UserResponse) {
                if (viewModelAuth.authenticated) {
                    ...
                    findNavController().navigate(R.id.action_allUsersFragment_to_detailedUserCardFragment)
                } else {
                    findNavController().navigate(R.id.action_allUsersFragment_to_dialogFragmentSignIn)
                }
            }
